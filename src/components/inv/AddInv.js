...
import { AdapterDayjs } from '@mui/x-date-pickers/AdapterDayjs' // Re-added import
    ...
    <div>
      <div className="wrapper d-flex flex-column min-vh-100 bg-light">
        ...
        <div className="body flex-grow-1 px-3">
          <CContainer fluid>
            <CCard>
              <CCardHeader>Add Metlife Investment</CCardHeader>
              <CCardBody>
                      ...
                      <CCol className="sm-12">
                        ...
                        <div id="error">
                          ...
                          {succesMsg && (
                            ...
                            >
                              <h5>You have added the Metlife amount correctly</h5>
                            </CAlert>
                          )}
                        </div>
                      </CCol>
