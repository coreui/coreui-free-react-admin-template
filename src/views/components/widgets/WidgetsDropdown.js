    ...
    <CRow>
      <CCol>
        <CWidgetDropdown
          className="mb-4"
          color="primary"
          value="src/views/components/widgets/WidgetDropDown/value"
          change={
            <>
              (src/views/components/widgets/WidgetDropDown/change <CIcon name="cil-arrow-bottom" />)
            </>
          }
          title="src/views/components/widgets/WidgetDropDown/title"
          action={
