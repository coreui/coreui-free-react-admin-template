...
import { CampaignTable, SelectColumnFilter } from './CampaignTable'
...
export const CampaignTablePage = withAdminAuth(true)(() => {
    ...
    useEffect(() => {
        (async () => {
            dispatch(fetchAllCampaigns(localStorage.getItem("admin_id")))
        })()
    }, [])
    ...
    return (
        <div>
            {loading ? (<div class="d-flex justify-content-center">
                ...
                <Styles>
                    <CampaignTable columns={columns} data={categories} pageIndex={currentPage} pageSize={totalItems} />
                </Styles>)}
